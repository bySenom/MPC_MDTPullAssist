-- MPC_MDTPullAssist - Embedded fingerprint data
-- Copied from MythicPlusCount's pre-built fingerprints for Midnight Season 1.
-- Format: [challengeMapID] = { ["modelFileID:relLevel:classification:sex:classToken:powerType"] = npcID }
-- Extended format adds ":buffCount" for disambiguation of identical base fingerprints.
local ADDON_NAME, NS = ...
local PA = NS.PullAssist

PA.EmbeddedFingerprints = {
    ...
    [558] = {
        ...
        ["1100258:1:elite:3:PALADIN:0"] = 251861, -- Blazing Pyromancer / Runed Spellbreaker
